...
public class InvalidAccountsEvent extends BaseEvent<InvalidAccountsAction, InvalidAccountsEventHandler>
{
	
public static Type<InvalidAccountsEventHandler> TYPE = new Type<InvalidAccountsEventHandler>();
	
	public InvalidAccountsEvent(InvalidAccountsAction action) {
		super(action);
	}
