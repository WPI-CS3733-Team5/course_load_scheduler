...
public class CourseInfo extends Model{
	...
	public void setRequiredFrequencyPerTerm(Integer requiredFrequencyPerTerm) {
	...
	public String toString() {
		return "CourseInfo [id=" + id + ", courseName=" + courseName + ", requiredFrequencyPerTerm="
				+ requiredFrequencyPerTerm + ", requiredFrequencyPerSemester=" + requiredFrequencyPerSemester
